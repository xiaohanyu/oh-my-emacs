...
- [[https://github.com/jorgenschaefer/elpy][elpy]], you can install it using [[http://www.pip-installer.org/en/latest/][pip]].
...
don't be afraid, beleive me, within minutes, you'll get an out-of-box Emacs
