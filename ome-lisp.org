...
[[http://leiningen.org/][leiningen]] 2.x. I recommand you to install it manually, since not all [[https://github.com/technomancy/leiningen/wiki/Packaging][package
...
Clojure the SLIME way. [[http://vimeo.com/22798433][Here]] is an awesome live demo to demostrate the Clojure
workflow.
