...
- [[file:ome-emacs-lisp.org][ome-emacs-lisp.org]]: settings for emacs-lisp.
- [[file:ome-common-lisp.org][ome-common-lisp.org]]: settings for Common Lisp, mainly [[http://common-lisp.net/project/slime/][SLIME]].
- [[file:ome-clojure.org][ome-clojure.org]]: settings for Clojure.
- [[file:ome-scheme.org][ome-scheme.org]]: settings for Scheme.
...
- [[file:ome-ocaml.org][ome-ocaml.org]]: minimal settings for OCaml.
