...
* Prerequisites Matrix
  :PROPERTIES:
  :CUSTOM_ID: ruby-prerequisites-matrix
  :END:
...
|      | Ubuntu/Debian/Mint   | ArchLinux       | CentOS           | Mac OS X        | Mandatory? |
|------+----------------------+-----------------+------------------+-----------------+------------|
| ruby | apt-get install ruby | pacman -S ruby  | yum install ruby |                 | Yes        |
| pry  | gem install pry      | gem install pry | gem install pry  | gem install pry | No         |
